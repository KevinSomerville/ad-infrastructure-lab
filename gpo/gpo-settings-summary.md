...
|----------|-----------|---------------------|----------------------|-------------|
| Sales-Wallpaper-Policy | Sales | Sets a custom desktop wallpaper | User Configuration > Policies > Administrative Templates > Desktop > Desktop Wallpaper | CLIENT-01 |
| Default Domain Policy (edited) | Domain-wide | Account lockout after 3 failed login attempts | Computer Configuration > Policies > Windows Settings > Security Settings > Account Policies > Account Lockout Policy | CLIENT-02 |
