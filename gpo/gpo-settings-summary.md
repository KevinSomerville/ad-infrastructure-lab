...
| Default Domain Policy | Domain-wide | Account lockout after 3 failed login attempts | Computer Configuration > Policies > Windows Settings > Security Settings > Account Policies > Account Lockout Policy | CLIENT-03 |

## Verification Method

For each GPO, scoping was verified in two ways:
